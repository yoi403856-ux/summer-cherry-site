...
const KITTEN = `_id, name, nameEn, "slug": slug.current, litter, litterEn, color, polydactyl, polydactylEn, sex, born, status, description, descriptionEn, images, order, father->${PARENT}, mother->${PARENT}`
const STUD = `_id, name, nameEn, call, callEn, "slug": slug.current, role, color, polydactyl, polydactylEn, weight, weightEn, titles, titlesEn, tests, testsEn, images, order`
