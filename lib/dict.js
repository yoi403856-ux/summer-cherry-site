...
export const T = {
  ru: {
    ...
    contactPopover: { title: 'Написать нам', close: 'Закрыть' },
    ...
    kittens: {
      ...
      empty: 'Котят пока нет — но совсем скоро здесь будут новые малыши Summer Cherry.',
      color: 'Окрас',
      polydactyl: 'Полидакт',
      born: 'Дата рождения',
      litter: 'Помёт',
  ...
  en: {
    ...
    contactPopover: { title: 'Write to us', close: 'Close' },
    ...
    kittens: {
      ...
      empty: 'No kittens right now — new Summer Cherry babies are on the way.',
      color: 'Colour',
      polydactyl: 'Polydact',
      born: 'Date of birth',
      litter: 'Litter',
